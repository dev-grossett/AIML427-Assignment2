...
@fig-hierarch_complete shows the resulting clusters plotted against the first two principal components of the data. As we can see, using a euclidean distance and complete linkage has resulted in one predominant cluster of genes and several smaller clusters. From this, we may be able to deduce that across the 64 different cancer cell lines in our dataset, the majority of genes show similar levels of expression
